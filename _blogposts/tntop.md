...
By probing the entanglement spectrum one can also learn about these quantities. For example for the $$\nu = 2/5$$ fractional quantum Hall state, the chiral central charge $$c$$, topological spin $$h$$ and shift $$\mathcal{S} \sim \eta_H$$ are measured to their expected quantized values of 2/24, 1/5, 4/16, respectively, through this method. 
